...
#CIB-07 Moduki 7 - Ciberseguridad
#============================================
...
#Formato: 'nombre_usuario' : 'contrasena'
usuarios = {
    'admin': 'Admin2024!',
    'estudiante1': 'Seguridad!',
...
#Contador de intentos (lista para modificarlo desde dentro de las funciones)
intentos = [0]
...
def verificar_login():
    ...
    # Si ya se agotaron los intentos, no hacer nada
    ...
    if usuario in usuarios and usuarios[usuario] == contrasena:
        ...
        if restantes > 0:
            etiqueta_error.config(text=f'Credenciales incorrectas. Intentos restantes: {restantes}')
        else:
...
boton_login = tk.Button(frame_form, text='Iniciar Sesion',
        command=verificar_login, bg='#cba6f7', fg='#1e1e2e',
